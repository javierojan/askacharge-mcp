...
| `askacharge_desbloquear_conector` | Release a stuck cable (OCPP `UnlockConnector`) |
| `askacharge_refrescar_estado` | Ask the charger to send its status/heartbeat/meter now (OCPP `TriggerMessage`) |
